<?php /* Smarty version 2.6.26, created on 2010-08-06 07:27:31
         compiled from home_anno_block.tpl.htm */ ?>
<div id="anno_main_block">
  <div id="anno_title_block">
  <a title="檢視所有公告" href="<?php echo $this->_tpl_vars['currcfg']['URL_ROOT_PATH']; ?>
/module/anno/list_anno.php">more...</a>
  </div>
...
"><?php if ($this->_tpl_vars['anno_item']['is_display'] == FALSE && $this->_tpl_vars['currmodule']->is_admin() == TRUE): ?><span class="warning_msg">[尚未發布] </span> <?php endif; ?><?php echo $this->_tpl_vars['anno_item']['title']; ?>
</a></span>
