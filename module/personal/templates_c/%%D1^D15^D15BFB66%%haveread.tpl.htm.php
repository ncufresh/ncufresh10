<?php /* Smarty version 2.6.26, created on 2010-08-06 07:30:32
         compiled from zh_tw/haveread.tpl.htm */ ?>
...
J(document).ready(function(){
	...
	<div class="m_back">
			...
			<?php if ($this->_tpl_vars['all_right'] == true): ?><div id="wait">刪除成功!</div><?php endif; ?> 
...
&where=haveread"><?php echo $this->_tpl_vars['mail_arr'][$this->_sections['i']['index']]['subject']; ?>
			    ...
			    <div class="mail_de"><a href="action.php?action=delete&mid=<?php echo $this->_tpl_vars['mail_arr'][$this->_sections['i']['index']]['mid']; ?>
"><img src="templates/zh_tw/images/mailbox/delete.png"></a></div><br/>
			</div>
			<?php endfor; endif; ?>   
	</div>
