<?php /* Smarty version 2.6.26, created on 2010-08-06 23:19:27
...
/"+ input + "\" />");
 ...
 jQuery(function(J){
	J('#exampleRange').datepicker({
		...
		<div class="back">
					<div class="must"><div class="star">*欄位為必填項目，無論任何更動都請輸入驗證碼喔<br/></div></div>
			<div class="text">
			<?php if ($this->_tpl_vars['all_right'] == false): ?><div id="wait"><?php echo $this->_tpl_vars['errmsg']; ?>
</div>	
				<form action="action.php?action=update" method="post">
                    <input type="hidden" value="<?php echo $this->_tpl_vars['ACticket']; ?>
" name="ticket"/>
			      <div class="head_i">
					<div id="head_image"><img src="<?php echo $this->_tpl_vars['currcfg']['URL_ROOT_PATH']; ?>
/<?php echo $this->_tpl_vars['post_head']; ?>
"/></div>
					<br/>
				   <?php echo $this->_tpl_vars['head_box']; ?>
...
"/><br /></div>
			      ...
			      <div class="passwd">-----------------不修改密碼以下密碼欄位請留空------------------</div>
			      <div class="star">*</div><div class="q">舊密碼:</div>
			      <div class="form"><input type="password" name="oldpassword"/><br/></div>
			      <div class="star">*</div><div class="q">新密碼:</div>
			      <div class="form"><input type="password" name="password" /><br /></div>
			      <div class="star">*</div><div class="q">確認新密碼:</div>
			      ...
			      <div class="button_1"><input type="image" border="0" src="templates/zh_tw/images/data/rewr2.png" value="寄出" /></div>
...
"/></div>
		...
		<!--			<select size=1 name="head" onChange="renew(this.options[this.selectedIndex].value);">
					    <option value="<?php echo $this->_tpl_vars['perdata']['head_image']; ?>
"></option>
					<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['head']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
"><?php echo $this->_tpl_vars['head'][$this->_sections['i']['index']]['headname']; ?>
			      ...
			      <div class="area">
			 	  <div class="star">*</div><div class="q">真實姓名:</div>
			 	  <div class="form"><input type="text" name="realname" value="<?php echo $this->_tpl_vars['perdata']['realname']; ?>
"/><br /></div>
			      <div class="star">*</div><div class="q">暱稱:</div>
			      <div class="form"><input type="text" name="nickname" value="<?php echo $this->_tpl_vars['perdata']['nickname']; ?>
"/><br /></div>
			      <div class="star">*</div><div class="q">系所:</div>
			      <div class="form">
			      <?php echo $this->_tpl_vars['box']; ?>
<br/></div>
			      ...
			      <div class="q">畢業高中:</div>
			      <div class="form"><input type="text" name="senior_high" value="<?php echo $this->_tpl_vars['perdata']['senior_high']; ?>
"/><br /></div>
			      <div class="q">生日:</div>
			      <div class="form"><input type="text" id="exampleRange" name="birthday" value="<?php echo $this->_tpl_vars['perdata']['birthday']; ?>
"><br /></div>
			      <div class="q">email:</div>
			      <div class="form"><input type="text" name="email" value="<?php echo $this->_tpl_vars['perdata']['email']; ?>
"/><br /></div>
			      <div class="q">個人首頁:</div>
			      <div class="form"><input type="text" name="self_website" value="<?php echo $this->_tpl_vars['perdata']['self_website']; ?>
"/><br /></div>
			      <div class="q_intro">自我介紹:</div>
			      <div class="form_intro"><textarea name="self_intro" cols="24" rows="5" class="myTextarea"><?php echo $this->_tpl_vars['perdata']['self_intro']; ?>
</textarea><br /></div>
			      <div class="passwd">-----------------不修改密碼以下密碼欄位請留空------------------</div>
			      <div class="star">*</div><div class="q">舊密碼:</div>
			      <div class="form"><input type="password" name="oldpassword"/><br/></div>
